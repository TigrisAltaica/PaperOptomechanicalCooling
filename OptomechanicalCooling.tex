...
cavity degrees of freedom. \fxnote*{El apendice
  esta incompleto, prometes derivar la ecuacion, pero no haces la
  traza con respecto a los modos de la cavidad}{The technical details of the
  derivation is reported in App.~\ref{CoolingAppendix}.} It leads to the master
equation
...
\begin{align}
  G(\nu,0)=&\int_0^\infty dt e^{(i\nu_0 +\epsilon'\cos{(2\omega t)})t }Tr[...]\nonumber\\
           ...
           &+\frac{i\epsilon}{2}\int_0^\infty cos(2\omega t)t e^{i (\nu_0+\delta)
             t}e^{-\frac{\kappa t}{2}}dt\, ,\nonumber
\end{align}
where the $e^{-\kappa t}$ factor acts as a cut-off for the integral, which
allows for the expansion in $\epsilon$ to be performed. \fxnote*{No
  entiendo que son los trace states, ni como usar el apendice aqui.}{See Appendix
\ref{App1} for more on the eigenvalues of the trace states.} This leads
