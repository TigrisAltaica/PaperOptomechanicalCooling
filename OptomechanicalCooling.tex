...
\end{equation}
Here we make the adiabatic approximation. For large enough $t$,
$e^{\lambda't}$ can be set equal to zero as the $\lambda'$ states
decay very quickly. We now also use that $\lambda$ states all have
eigenvalues equal to zero, as only those eigenvalues have no negative
real part. This makes the first term
