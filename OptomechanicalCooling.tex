...
\fxnote{¿Vale la pena una discusion del significado de las
  excitaciones e introducir el operador de numero aqui, o lo dejamos
  donde esta?}
...
non-driven case over a range around the minimum point. \fxnote*{Agregue
  esta frase, checa que sea cierto. ¿Valdra la pena aqui agregar una
  lista de todas las aproximaciones hechas?}{As long as the parameters
  satisfy the assumptions done in the derivation, the final
  temperature does not depend on the driven frequency $\omega$.}
...
\eqref{eq:ProyectedMasterEqCooling}. When arranging in this form, the
...
\fxnote{Poner explicitamente la ecuacion de $\mu$ con $A_-$ y $A_+$ aqui, poner
  la expresion que usaste para derivar las expresiones (44) y (45),
  que debe ser una expresion con trazas relativamente compacta.
  Agregar despues una pequeña discusion de como se agrega la
  disipacion del oscilador y porque no la tomamos en cuenta en el
  texto (en el articulo con Marc o en las notas hay una discusion de
  eso, no me acuerdo bien en donde)}
