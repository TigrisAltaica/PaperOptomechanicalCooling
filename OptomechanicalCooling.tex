...
\fxnote{Creo que va en el apéndice, me abstengo de hacerlo hasta que estén tus cambios} $\overline{H}$ is a term proportional
...
\ref{CoolingAppendix}\fxnote{Lo pongo cuando ya estén tus cambios al apéndice}.
...
\fxnote*{Le faltaba una palabra}{It must be noted that since terms
  of order $\frac{\delta_t}{\delta^2}$ are neglected, the approximation does not hold
  as $\delta$ approaches 0.} The approximation is valid near
$\frac{\delta}{\nu_0} = -1$, since we only keep one term for the
correction to $\delta$, \fxnote{and this correction assumes that $|\frac{\delta_t}{\nu_0}|<<1$ so, at this level of approximation, we require that $\delta \approx \nu_0$}
\fxnote{As can be seen in figure \ref{fig:TempRatio}, the corrected temperature begins to rise in comparison to the uncorrected temperature around $\frac{\delta}{\nu_0}=-1.5$ and also begins to rapidly rise near $\frac{\delta}{\nu_0}=-.7$. These points seem to signal where the approximation begins to break down.}
