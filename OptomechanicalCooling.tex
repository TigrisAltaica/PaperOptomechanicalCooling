...
\end{align}
where $\lambda_c$ represents the eigenvalues for the cavity's states. The real part of these eigenvalues is either zero or negative and acts as a cut-off for the integral.
