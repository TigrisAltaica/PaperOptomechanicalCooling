...
\begin{equation}
Tr_a[X_a e^{L_a t} X_a \rho_{st}] = \frac{1}{2},
\end{equation} while $e^{L_a}$ leaves the trace as $e^{-\kappa}$ and acts as a as a cut-off for the integral. See Appendix \ref{App1} for more on the eigenvalues of the trace states.
