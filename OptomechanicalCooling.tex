...
\fxnote*{No es claro como lo haces, lo puedes poner de forma mas
  explicita?}{This of course adds and additional term to the $\beta$
  equation \eqref{eq:displaced_frame}, $-i\nu_0$, as the term involving $\dot{\Gamma}$ and $\dot{\Gamma}^\dagger$ is completely analogous to the laser pump term after perfoming this substitution and can also be eliminated by the shift in reference frame. }. With an explicit solution for
