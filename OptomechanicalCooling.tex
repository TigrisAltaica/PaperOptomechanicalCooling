...
$\mathcal{L}_0+\mathcal{L}_0^t(t)$ with purely imaginary  eigenvalues. The projectors with the
...
\end{equation}  where $\delta(t)=\frac{\delta_t}{\nu_0} \sin(\nu_0t)$ and $\lambda_c$ represents the value of $a^\dagger a$. Each term is now integrated separately. For the
first term
